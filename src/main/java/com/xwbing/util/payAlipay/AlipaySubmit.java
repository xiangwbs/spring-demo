package com.xwbing.util.payAlipay;
...
public class AlipaySubmit {
     ...
     */
    private static final String ALIPAY_GATEWAY_NEW = "https://mapi.payAlipay.com/gateway.do?";
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        if(sPara.get("sign_type") !=null && sPara.get("sign_type").equals("RSA") ) {
        	mysign = RSA.sign(prestr, sPara.get("key"),sPara.get("_input_charset"));
        }else{
	...
	public static String query_timestamp(String partner) throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + partner + "&_input_charset=utf-8";
